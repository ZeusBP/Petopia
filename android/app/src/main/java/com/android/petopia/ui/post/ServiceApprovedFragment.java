 ...
 * Use the {@link ServiceApprovedFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ServiceApprovedFragment extends Fragment {
    ...
    public ServiceApprovedFragment() {
     ...
     * @return A new instance of fragment ServiceApprovedFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ServiceApprovedFragment newInstance(String param1, String param2) {
        ServiceApprovedFragment fragment = new ServiceApprovedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_service_approved, container, false);
    ...
    private void initData() {
        ...
        service.getMyService(DataLocalManager.getUser().getId(),"ACTIVE","Bearer " + DataLocalManager.getToken()).enqueue(new Callback<List<Service>>() {
            @Override
