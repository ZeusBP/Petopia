...
public class ToPayOrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_to_pay_order, container, false);
    ...
    private void initData() {
        ...
        service.getMyOrderFilter(DataLocalManager.getUser().getId(),"PENDING","Bearer " + DataLocalManager.getToken()).enqueue(new Callback<DataOrder>() {
            @Override
