...
public class PostLostPetActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_lost_pet);
    ...
    private void saveBlog() {
        ...
        CatePet catePet = new CatePet(1, "LostPet");
        ...
        for (int i = 0; i < uris.size(); i++) {
            MediaManager.get().upload(uris.get(i)).callback(new UploadCallback() {
                ...
                public void onError(String requestId, ErrorInfo error) {
                    ...
                    Toast.makeText(PostLostPetActivity.this, "Error!", Toast.LENGTH_SHORT).show();
                }
    ...
    private void putApi() {
        ...
        service.createPet(pet, "Bearer " + DataLocalManager.getToken()).enqueue(new Callback<Pet>() {
            ...
            public void onResponse(Call<Pet> call, Response<Pet> response) {
                progressDialog.dismiss();
                Toast.makeText(PostLostPetActivity.this, "Create success!", Toast.LENGTH_SHORT).show();
                gotoProfile();
            }
