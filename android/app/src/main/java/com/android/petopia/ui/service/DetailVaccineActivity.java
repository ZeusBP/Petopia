...
public class DetailVaccineActivity extends AppCompatActivity {
    List<Service> listService = new ArrayList<>();
    ServiceAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_vaccine);
        initView();
    }
    private void initView() {
        RecyclerView rvVets = findViewById(R.id.rvService_Vaccine);
        //B1 data
        initData();
    ...
    private void initData() {
        ...
        service.getService(3,"ACTIVE","Bearer " + DataLocalManager.getToken()).enqueue(new Callback<List<Service>>() {
            @Override
            public void onResponse(Call<List<Service>> call, Response<List<Service>> response) {
                if (response.body() != null){
                    ...
                    Toast.makeText(DetailVaccineActivity.this, "Error!", Toast.LENGTH_SHORT).show();
                }
            }
