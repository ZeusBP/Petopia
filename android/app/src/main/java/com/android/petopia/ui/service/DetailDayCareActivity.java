...
public class DetailDayCareActivity extends AppCompatActivity {
    List<Service> listService = new ArrayList<>();
    ServiceAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_day_care);
        initView();
    }

    private void initView() {
        RecyclerView rvVets = findViewById(R.id.rvService_Daycare);
        //B1 data
        initData();
    ...
    private void initData() {
        ...
        service.getService(1,"ACTIVE","Bearer " + DataLocalManager.getToken()).enqueue(new Callback<List<Service>>() {
            @Override
            public void onResponse(Call<List<Service>> call, Response<List<Service>> response) {
                if (response.body() != null){
                    ...
                    Toast.makeText(DetailDayCareActivity.this, "Error!", Toast.LENGTH_SHORT).show();
                }
            }
