...
public class DetailPetAdoptActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_pet_adopt);

        petData = (Pet) getIntent().getSerializableExtra("PETADOPT");
