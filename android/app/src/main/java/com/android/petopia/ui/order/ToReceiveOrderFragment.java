 ...
 * Use the {@link ToReceiveOrderFragment#newInstance} factory method to
...
public class ToReceiveOrderFragment extends Fragment {
     ...
     * @return A new instance of fragment ToReceiveOrderFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ToReceiveOrderFragment newInstance(String param1, String param2) {
        ToReceiveOrderFragment fragment = new ToReceiveOrderFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_to_receive_order, container, false);
    ...
    private void initData() {
        ...
        service.getMyOrderFilter(DataLocalManager.getUser().getId(),"PROCESSING","Bearer " + DataLocalManager.getToken()).enqueue(new Callback<DataOrder>() {
            @Override
