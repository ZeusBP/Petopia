...
import com.android.petopia.ui.login.LoginActivity;
 ...
 * Use the {@link PetAdoptionFragment#newInstance} factory method to
...
public class PetAdoptionFragment extends Fragment {
     ...
     * @return A new instance of fragment PetAdoptionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PetAdoptionFragment newInstance(String param1, String param2) {
        PetAdoptionFragment fragment = new PetAdoptionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rvPetAdoption = (RecyclerView) view.findViewById(R.id.rvPetAdoption);
        //B1 data
        initData();
        ...
        //B4 RecycleView
        rvPetAdoption.setLayoutManager(layoutManager);
        rvPetAdoption.setAdapter(adapter);
        return view;
    }
