...
public class DetailLostPetActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_lost_pet);

        petData = (Pet) getIntent().getSerializableExtra("LOSTPET");
    ...
    private void initData() {
        etName.setText(petData.getName());
        etPetAge.setText(petData.getAge());
        etAddress.setText(petData.getAddress());
        etPetBreed.setText(petData.getBreed());
        etDescription.setText(petData.getDescription());
        PetType = petData.getTypePet().getName();
        PetSex = petData.getSex();
        urisThumbnail.add(Uri.parse(petData.getThumbnail()));
        for (String image: petData.getImage().split(",")
        ) {
        ...
        for (int i = 0; i < uris.size(); i++) {
            MediaManager.get().upload(uris.get(i)).callback(new UploadCallback() {
                ...
                public void onError(String requestId, ErrorInfo error) {
                    ...
                    Toast.makeText(DetailLostPetActivity.this, "Error!", Toast.LENGTH_SHORT).show();
                }
    ...
    private void putThumbnail() {
        if (countImageSuccess == uris.size() - 1) {
...
//                progressDialog.dismiss();
//                Toast.makeText(DetailPetAdoptActivity.this, "Create success!", Toast.LENGTH_SHORT).show();
//                gotoProfile();
//            }
//
//            @Override
...
//                progressDialog.dismiss();
//                Toast.makeText(DetailPetAdoptActivity.this, "Error!", Toast.LENGTH_SHORT).show();
//            }
//        });
    }
