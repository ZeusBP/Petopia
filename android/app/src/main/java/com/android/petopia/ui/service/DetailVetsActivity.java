...
public class DetailVetsActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        service.getService(5,"ACTIVE","Bearer " + DataLocalManager.getToken()).enqueue(new Callback<List<Service>>() {
            @Override
            public void onResponse(Call<List<Service>> call, Response<List<Service>> response) {
                if (response.body() != null){
                    ...
                    Toast.makeText(DetailVetsActivity.this, "Error!", Toast.LENGTH_SHORT).show();
                }
            }
